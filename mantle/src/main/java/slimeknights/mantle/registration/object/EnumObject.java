...
public class EnumObject<T extends Enum<T>, I> implements MultiObject<I> {
  ...
  /**
   * Gets a list of values in this enum object. Will error if a {@link slimeknights.mantle.registration.RegistryObject} cannot be resolved, unlike {@link #forEach(Consumer)}
