...
import slimeknights.tconstruct.library.tools.definition.module.build.ItemAbilitiesModule;
...
public final class TinkerTools extends TinkerModule {
  ...
  public static final RegistryObject<LootItemFunctionType<AddToolDataFunction>> lootAddToolData = LOOT_FUNCTIONS.register("add_tool_data", () -> new LootItemFunctionType<>(AddToolDataFunction.CODEC));
  public static final RegistryObject<net.minecraft.advancements.critereon.ItemSubPredicate.Type<?>> toolStackPredicate = ITEM_SUB_PREDICATES.register("tool_stack", () -> ToolStackItemPredicate.TYPE);
  ...
  static {
    ...
    if (ModList.get().isLoaded("twilightforest")) {
      ...
      minotaurAxe = new ItemObject<>(RegistryObject.of(DeferredHolder.create(Registries.ITEM, getResource("minotaur_axe"))));
    }
  }

  // armor
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> travelersGear = ITEMS.registerEnum("travelers", ARMOR_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.TRAVELERS, type, UNSTACKABLE_PROPS));
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> plateArmor = ITEMS.registerEnum("plate", ARMOR_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.PLATE, type, UNSTACKABLE_PROPS));
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      ...
      ToolModule.LOADER.register(getResource("tool_actions"), ItemAbilitiesModule.LOADER);
