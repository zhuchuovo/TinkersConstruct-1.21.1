...
public class CopperCanFluidHandler implements IFluidHandlerItem {
  ...
  /** Creates a stack using the can's legacy custom-data payload. */
  private FluidStack createFluidStack(Fluid fluid, int amount) {
    FluidStack stack = new FluidStack(fluid, amount);
    FluidStackUtil.setTag(stack, getFluidTag());
    return stack;
  }
  ...
  public FluidStack getFluidInTank(int tank) {
    ...
    return createFluidStack(getFluid(), getCapacity());
  }
  ...
  public FluidStack drain(FluidStack resource, FluidAction action) {
    ...
    FluidStack output = createFluidStack(fluid, capacity);
