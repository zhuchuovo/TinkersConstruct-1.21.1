...
public class TinkerEffect extends MobEffect {
  ...
  public TinkerEffect addAttributeModifier(Attribute pAttribute, String pUuid, double pAmount, Operation pOperation) {
    return addAttributeModifier(BuiltInRegistries.ATTRIBUTE.wrapAsHolder(pAttribute), pUuid, pAmount, pOperation);
  }
  ...
  /** Gets the level for a registry holder, starting from 1, or 0 if inactive. */
