...
public class Config {
  ...
  public static class Common {
    ...
    Common(ModConfigSpec.Builder builder) {
      ...
      // Vanilla enchantments are data-driven immutable registry entries in 1.21.
      // The former slot mutation toggles must be replaced by enchantment data overrides.
