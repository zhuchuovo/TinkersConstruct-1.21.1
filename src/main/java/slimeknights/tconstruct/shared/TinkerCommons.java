...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final Supplier<GlowBlock> glow = glowBlock;
  // glass
  ...
  /* Custom ingredients */
  public static final RegistryObject<IngredientType<NoContainerIngredient>> noContainerIngredient =
    INGREDIENT_TYPES.register("no_container", () -> NoContainerIngredient.TYPE);
  public static final RegistryObject<IngredientType<BlockTagIngredient>> blockTagIngredient =
    INGREDIENT_TYPES.register("block_tag", () -> BlockTagIngredient.TYPE);
  ...
  public static final RegistryObject<MapCodec<? extends ICondition>> configCondition = CONDITION_SERIALIZERS.register("config", () -> ConfigEnabledCondition.CODEC);
  public static final RegistryObject<MapCodec<? extends ICondition>> tagIntersectionCondition = CONDITION_SERIALIZERS.register("tag_intersection_present", () -> TagIntersectionPresentCondition.CODEC);
  public static final RegistryObject<MapCodec<? extends ICondition>> tagDifferenceCondition = CONDITION_SERIALIZERS.register("tag_difference_present", () -> TagDifferencePresentCondition.CODEC);
  public static final RegistryObject<MapCodec<? extends ICondition>> tagNotEmptyCondition = CONDITION_SERIALIZERS.register("tag_not_empty", () -> TagNotEmptyCondition.CODEC);
  ...
  public static final RegistryObject<BlockContainerOpenedTrigger> CONTAINER_OPENED_TRIGGER = CRITERIA_TRIGGERS.register("block_container_opened", BlockContainerOpenedTrigger::new);
