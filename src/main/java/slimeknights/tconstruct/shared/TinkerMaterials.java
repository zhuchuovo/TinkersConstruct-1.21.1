...
public final class TinkerMaterials extends TinkerModule {
  public static final RegistryObject<IngredientType<MaterialIngredient>> materialIngredient =
    INGREDIENT_TYPES.register("material", () -> MaterialIngredient.TYPE);
  public static final RegistryObject<IngredientType<MaterialValueIngredient>> materialValueIngredient =
    INGREDIENT_TYPES.register("material_value", () -> MaterialValueIngredient.TYPE);
