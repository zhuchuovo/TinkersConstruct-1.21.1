...
public class JsonRedirect {
  ...
  public JsonObject toJson() {
    ...
    if (condition != null) {
      json.add("condition", ICondition.CODEC.encodeStart(JsonOps.INSTANCE, condition).getOrThrow(com.google.gson.JsonParseException::new));
    }
    return json;
  }
  ...
  public static JsonRedirect fromJson(JsonObject json) {
    ...
    if (json.has("condition")) {
      condition = ICondition.CODEC.parse(JsonOps.INSTANCE, json.get("condition")).getOrThrow(com.google.gson.JsonParseException::new);
    }
