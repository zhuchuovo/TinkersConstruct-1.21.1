...
public class ToolPartLootEntry extends LootPoolSingletonContainer {
  public static final MapCodec<ToolPartLootEntry> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
      TagKey.codec(net.minecraft.core.registries.Registries.ITEM).fieldOf("tag").forGetter(value -> value.tag),
      new LoadableCodec<>(RandomMaterial.LOADER).fieldOf("material").forGetter(value -> value.material))
