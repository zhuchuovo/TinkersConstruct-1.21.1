...
public class ModifierHooks {
  ...
  public static final ModuleHook<ItemAbilityModifierHook> TOOL_ACTION = register("tool_action", ItemAbilityModifierHook.class, ItemAbilityModifierHook.AnyMerger::new, (tool, modifier, toolAction) -> false);
  ...
  public static final ModuleHook<EnchantmentModifierHook> ENCHANTMENTS = register("enchantments", EnchantmentModifierHook.class, EnchantmentModifierHook.AllMerger::new, new EnchantmentModifierHook() {
    ...
    @Override
    public void updateEnchantments(IToolStackView tool, ModifierEntry modifier, net.minecraft.core.HolderLookup.RegistryLookup<Enchantment> lookup, Map<net.minecraft.core.Holder<Enchantment>,Integer> map) {}
  });
