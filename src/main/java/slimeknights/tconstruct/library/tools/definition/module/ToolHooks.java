...
public class ToolHooks {
  ...
  /** Hook for checking if a tool can perform a given action. */
  public static final ModuleHook<ItemAbilityToolHook> TOOL_ACTION = register("tool_actions", ItemAbilityToolHook.class, ItemAbilityToolHook.AnyMerger::new, (tool, action) -> false);
