...
public class MutableUseOnContext extends UseOnContext {
  ...
  public MutableUseOnContext(UseOnContext base) {
    this(base.getLevel(), base.getPlayer(), base.getHand(), base.getItemInHand(),
      new BlockHitResult(base.getClickLocation(), base.getClickedFace(), base.getClickedPos(), base.isInside()));
  }
