...
public final class TinkerStructures extends TinkerModule {
  ...
  public TinkerStructures() {
    IEventBus bus = TConstruct.getModBus();
   ...
   * Misc
   */
  public static final RegistryObject<TreeDecoratorType<LeaveVineDecorator>> leaveVineDecorator = RegistryObject.of(TREE_DECORATORS.register("leave_vines", () -> new TreeDecoratorType<>(LeaveVineDecorator.CODEC)));
  public static final RegistryObject<RootPlacerType<ExtraRootVariantPlacer>> extraRootVariantPlacer = RegistryObject.of(ROOT_PLACERS.register("extra_root_variants", () -> new RootPlacerType<>(ExtraRootVariantPlacer.CODEC)));

  /*
   * Features
   */
  /** Overworld variant of slimy trees */
  public static final RegistryObject<SlimeTreeFeature> slimeTree = RegistryObject.of(FEATURES.register("slime_tree", () -> new SlimeTreeFeature(SlimeTreeConfig.CODEC)));
  /** Nether variant of slimy trees */
  public static final RegistryObject<SlimeFungusFeature> slimeFungus = RegistryObject.of(FEATURES.register("slime_fungus", () -> new SlimeFungusFeature(SlimeFungusConfig.CODEC)));
   ...
   * Structures
   */
  public static final RegistryObject<StructurePieceType> islandPiece = RegistryObject.of(STRUCTURE_PIECE.register("island", () -> IslandPiece::new));
  public static final RegistryObject<StructureType<IslandStructure>> island = RegistryObject.of(STRUCTURE_TYPE.register("island", () -> () -> IslandStructure.CODEC));
